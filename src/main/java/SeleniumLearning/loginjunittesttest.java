...
class LoginJunitTestTest extends Basetestvijay {
    @Test
    ...
    public void test02() throws InterruptedException {
        ...
        getDriver().findElement(By.linkText("Login with password instead")).click();
        getDriver().findElement(By.xpath("//input[@id='lusername']")).sendKeys(configuration.USER_NAME_LIVE);
        getDriver().findElement(By.xpath("//input[@id='lpassword']")).sendKeys(configuration.PASSWORD_LIVE);
        getDriver().findElement(By.xpath("//button[text()='LOG IN']")).click();
        getDriver().switchTo().frame(0);
        getDriver().findElement(By.xpath("//span[text()='PRACTICE']")).click();
        WebDriverWait wait = new WebDriverWait(getDriver(),Duration.ofSeconds(10));
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[text()='DEALS']")));
        getDriver().findElement(By.xpath("//span[text()='DEALS']")).click();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='10167']")));
        getDriver().findElement(By.xpath("//button[@id='10167']")).click();
        String mainWindowHandle =getDriver().getWindowHandle();
        Set<String> allWindowHandle = getDriver().getWindowHandles();
        Iterator<String> iter = allWindowHandle.iterator();
        while (iter.hasNext()) {
